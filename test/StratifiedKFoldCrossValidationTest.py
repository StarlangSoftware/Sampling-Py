...
class StratifiedKFoldCrossValidationTest(unittest.TestCase):
    ...
    def test_SmallSample10Fold(self):
        ...
        expected1 = ["7", "22", "16"]
        self.assertEquals(expected1, stratifiedKFoldCrossValidation.getTestFold(0))
    ...
    def test_SmallSample5Fold(self):
        ...
        self.assertEquals(expected2, stratifiedKFoldCrossValidation.getTestFold(0))
    ...
    def test_SmallSample2Fold(self):
        ...
        self.assertEquals(expected3, stratifiedKFoldCrossValidation.getTestFold(0))
    ...
    def test_LargeSample10Fold(self):
        ...
        for i in range(10):
            ...
            self.assertEquals(900, len(testFold))
            self.assertEquals(8100, len(trainFold))
            ...
            self.assertEquals(900, trainCounts[0])
            self.assertEquals(2700, trainCounts[1])
            self.assertEquals(4500, trainCounts[2])
            testCounts = [0, 0, 0]
            ...
            self.assertEquals(100, testCounts[0])
            self.assertEquals(300, testCounts[1])
            self.assertEquals(500, testCounts[2])
    ...
    def test_LargeSample2Fold(self):
        ...
        for i in range(2):
            ...
            items.update(trainFold)
            items.update(testFold)
            self.assertEquals(4500, len(testFold))
            self.assertEquals(4500, len(trainFold))
            self.assertEquals(9000, len(items))
            trainCounts = [0, 0, 0]
            for integer in trainFold:
                if integer < 1000:
                    ...
                    trainCounts[2] = trainCounts[2] + 1
            self.assertEquals(500, trainCounts[0])
            self.assertEquals(1500, trainCounts[1])
            self.assertEquals(2500, trainCounts[2])
            testCounts = [0, 0, 0]
            for integer in testFold:
                if integer < 1000:
                    testCounts[0] = testCounts[0] + 1
                    ...
                    testCounts[2] = testCounts[2] + 1
            self.assertEquals(500, testCounts[0])
            self.assertEquals(1500, testCounts[1])
            self.assertEquals(2500, testCounts[2])
